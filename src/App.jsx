      ...
      <BrowserRouter>
        ...
        >
          <Routes>
            ...
            <Route
              path="/guarani"
              element={<Navigate to="/livro/guarani" replace />}
            />
            <Route
              path="/quartos-despejo"
              element={<Navigate to="/livro/quartos-despejo" replace />}
            />
            <Route
              path="/memorias-cubas"
              element={<Navigate to="/livro/memorias-cubas" replace />}
            />
            <Route
              path="/bookverse"
              element={<Navigate to="/livro/bookverse" replace />}
            />
            <Route
              path="/vidas-secas"
              element={<Navigate to="/livro/vidas-secas" replace />}
            />
