        ...
        <main className={styles.homeContainer}>
            ...
            <section className={styles.destaques}>
                <div className={styles.apresentacao}>
                    ...
                    <p>
                        Este projeto está sendo feito como uma atividade que liga o instituto Sesi
                        com Senai, como meio de aprendizagem entres as duas instituições, utilizando
                        a prática dos dois lados. O projeto consiste em uma biblioteca virtual onde
                        temos somente livros do vestibular, como foco do nosso grupo sendo o livro
                        "Capitães da areia".
                    </p>
                </div>
                ...
                <div className={styles.cards}>
                    ...
                    <Link to="/vestibular" className={styles.vestibulandos}>
                        <h4>Vestibulandos</h4>
                        <p>
                            Encontre cronogramas, análises dos principais vestibulares e tudo o que
                            você precisa para gabaritar a prova.
                        </p>
                        <p>Estudar → </p>
                    </Link>
            ...
            <section className={styles.biblioteca}>
                ...
                <div className={styles.bibliotecaRealOficial}>
                    <div className={styles.topBiblioteca}>
                        ...
                        <Link to="/biblioteca" className={styles.verTodos} onClick={() => {}}>
                    ...
                    <div className={styles.cardsLivro}>
                        <Link>
                            ...
                            <div className={styles.infoLivro}>
                                <h4>{livro.titulo}</h4>
                                <span>{livro.autor || livro.escritor || 'Autor desconhecido'}</span>
                            </div>
                        </Link>
                    </div>
                </div>
